...
{
    public class NominationVolumeMap : EntityTypeConfiguration<NominationVolume>
    {
        public NominationVolumeMap()
        {
            // Primary Key
            ...
            this.ToTable("NominationVolumes");
            ...
            // Relationships
            this.HasRequired(t => t.NominationShipper)
                .WithMany(t => t.NominationVolumes)
                .HasForeignKey(d => d.NominationShipperId);
