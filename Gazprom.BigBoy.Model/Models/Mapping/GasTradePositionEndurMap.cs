...
{
    public class GasTradePositionEndurMap : EntityTypeConfiguration<GasTradePositionEndur>
    {
        public GasTradePositionEndurMap()
        {
            // Primary Key
            this.HasKey(t => new { t.TradeId, t.Location, t.BuySell, t.StartDateUTC });
            ...
            this.ToTable("GasTradePositionEndur");
