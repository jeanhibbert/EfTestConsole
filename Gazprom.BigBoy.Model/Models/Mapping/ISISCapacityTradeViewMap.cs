...
{
    public class ISISCapacityTradeViewMap : EntityTypeConfiguration<ISISCapacityTradeView>
    {
        public ISISCapacityTradeViewMap()
        {
            // Primary Key
            ...
            this.ToTable("ISISCapacityTradeView", "caprpt");
